...
function sasiedzi = fPoliczSasiadow(plansza,x,y,zliczany_elem)
    suma = 0;
    ...
    if x>1 && y>1 % w przeciwnym razie nie ma co zliczac, bo nie ma nikogo u gory po lewej
        if plansza(x-1,y-1)==zliczany_elem
            suma = suma+1;
        end
    end
